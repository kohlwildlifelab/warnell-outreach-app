...
custom_css <- "
  ...
  .outreach-table .label-col { text-align: left; font-style: italic; width: 25%; font-weight: 500; background-color: #fafafa; padding-left: 10px; }
  .total-column { font-weight: bold; background-color: #f0f0f0; width: 80px; }
  ...
  @media print {
    .main-header, .btn, .action-button, .header-box p { display: none !important; }
      ...
      column(width = 10, offset = 1,
                 ...
                 tags$table(class = "outreach-table",
                            tags$thead(
                              tags$tr(
                                ...
                                tags$th(colspan=2, "Quantity"), tags$th(colspan=2, "Points"), tags$th(rowspan=2, "Total")
                              ),
             ...
             box(title = "II - Outreach Publications", width = 12, status = "primary", solidHeader = TRUE,
                 tags$table(class = "outreach-table",
                            tags$thead(
                              tags$tr(
                                tags$th(class="cat-header", rowspan=2, "Category"), 
                                tags$th(colspan=4, "Quantity"), tags$th(colspan=3, "Points"), tags$th(rowspan=2, "Total")
                              ),
                              tags$tr(
                                tags$th("New"), tags$th("Major"), tags$th("Minor"), tags$th("Prestige"),
                                tags$th("Base"), tags$th("Major Rev"), tags$th("Minor Rev")
                              )
                            ),
                            tags$tbody(
                              tags$tr(tags$td(class="label-col", "Books"), tags$td(numericInput("q_book", NULL, 0, min=0)), tags$td(""), tags$td(""), tags$td(numericInput("p_book", NULL, 0, min=0)), tags$td("15"), tags$td(""), tags$td("+1"), tags$td(class="total-column", textOutput("t_book_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Book Chapters"), tags$td(numericInput("q_chap", NULL, 0, min=0)), tags$td(""), tags$td(""), tags$td(numericInput("p_chap", NULL, 0, min=0)), tags$td("9"), tags$td(""), tags$td("+1"), tags$td(class="total-column", textOutput("t_chap_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Peer-reviewed Articles"), tags$td(numericInput("q_jrnl", NULL, 0, min=0)), tags$td(""), tags$td(""), tags$td(numericInput("p_jrnl", NULL, 0, min=0)), tags$td("9"), tags$td(""), tags$td("+1"), tags$td(class="total-column", textOutput("t_jrnl_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Proceedings"), tags$td(numericInput("q_proc", NULL, 0, min=0)), tags$td(""), tags$td(""), tags$td(numericInput("p_proc", NULL, 0, min=0)), tags$td("7"), tags$td(""), tags$td("+1"), tags$td(class="total-column", textOutput("t_proc_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Outreach Document"), tags$td(numericInput("q_out", NULL, 0, min=0)), tags$td(numericInput("ma_out", NULL, 0, min=0)), tags$td(numericInput("mi_out", NULL, 0, min=0)), tags$td(""), tags$td("5"), tags$td("1.5"), tags$td("2.5"), tags$td(class="total-column", textOutput("t_out_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Technical Outreach Doc"), tags$td(numericInput("q_tech", NULL, 0, min=0)), tags$td(numericInput("ma_tech", NULL, 0, min=0)), tags$td(numericInput("mi_tech", NULL, 0, min=0)), tags$td(""), tags$td("10"), tags$td("2.5"), tags$td("5"), tags$td(class="total-column", textOutput("t_tech_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Gray Lit, Popular Press"), tags$td(numericInput("q_gray", NULL, 0, min=0)), tags$td(""), tags$td(""), tags$td(""), tags$td("4"), tags$td(""), tags$td(""), tags$td(class="total-column", textOutput("t_gray_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Websites, Apps"), tags$td(numericInput("q_app", NULL, 0, min=0)), tags$td(numericInput("ma_app", NULL, 0, min=0)), tags$td(numericInput("mi_app", NULL, 0, min=0)), tags$td(""), tags$td("10"), tags$td("2.5"), tags$td("5"), tags$td(class="total-column", textOutput("t_app_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Podcasts"), tags$td(numericInput("q_pod", NULL, 0, min=0)), tags$td(""), tags$td(""), tags$td(""), tags$td("5"), tags$td(""), tags$td(""), tags$td(class="total-column", textOutput("t_pod_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Social Media Posts"), tags$td(numericInput("q_smp", NULL, 0, min=0)), tags$td(""), tags$td(""), tags$td(""), tags$td("0.1"), tags$td(""), tags$td(""), tags$td(class="total-column", textOutput("t_smp_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Social Media Products"), tags$td(numericInput("q_smprod", NULL, 0, min=0)), tags$td(""), tags$td(""), tags$td(""), tags$td("1.5"), tags$td(""), tags$td(""), tags$td(class="total-column", textOutput("t_smprod_out", inline=T)))
                            )
                 )
             ),
             ...
             box(title = "III - Outreach Events", width = 12, status = "primary", solidHeader = TRUE,
                 tags$table(class = "outreach-table",
                            tags$thead(
                              tags$tr(
                                tags$th(class="cat-header", rowspan=2, "Category"), 
                                tags$th(colspan=3, "Quantity"), tags$th(colspan=3, "Points"), tags$th(rowspan=2, "Total")
                              ),
                              tags$tr(tags$th("New"), tags$th("Repeated"), tags$th("Substantial"), tags$th("New"), tags$th("Rep"), tags$th("Subst"))
                            ),
                            tags$tbody(
             ...
             box(title = "IV - Outreach Funding", width = 12, status = "primary", solidHeader = TRUE,
                 tags$table(class = "outreach-table",
                            tags$thead(
                              tags$tr(
                                tags$th(class="cat-header", rowspan=2, "Funding Type"), 
                                tags$th(colspan=3, "Quantity"), tags$th(colspan=3, "Points"), tags$th(rowspan=2, "Total")
                              ),
                              tags$tr(tags$th("Small"), tags$th("Normal"), tags$th("Substantial"), tags$th("Small"), tags$th("Normal"), tags$th("Subst"))
                            ),
                            tags$tbody(
             ...
             box(title = "V - Technical Assistance", width = 12, status = "primary", solidHeader = TRUE,
                 tags$table(class = "outreach-table",
                            tags$thead(
                              tags$tr(
                                tags$th(class="cat-header", rowspan=2, "Service Format"), 
                                tags$th(colspan=1, "Quantity"), tags$th(colspan=1, "Points"), tags$th(rowspan=2, "Total")
                              ),
             ...
             box(title = "VI - Outreach Awards", width = 12, status = "primary", solidHeader = TRUE,
                 tags$table(class = "outreach-table",
                            tags$thead(
                              tags$tr(
                                tags$th(class="cat-header", rowspan=2, "Recognition"), 
                                tags$th(colspan=2, "Quantity"), tags$th(colspan=2, "Points"), tags$th(rowspan=2, "Total")
                              ),
                              tags$tr(tags$th("Base"), tags$th("Prestige"), tags$th("Base"), tags$th("Prestige"))
                            ),
                            tags$tbody(
                              tags$tr(tags$td(class="label-col", "Award/Recognition"), tags$td(numericInput("aw_b", NULL, 0, min=0)), tags$td(numericInput("aw_p", NULL, 0, min=0)), tags$td("5"), tags$td("+2.5"), tags$td(class="total-column", textOutput("t_award_out", inline=T)))
                            )
                 )
             ),
             ...
             box(title = "VII - Media Contributions", width = 12, status = "primary", solidHeader = TRUE,
                 tags$table(class = "outreach-table",
                            tags$thead(
                              tags$tr(
                                tags$th(class="cat-header", rowspan=2, "Media Type"), 
                                tags$th(colspan=1, "Quantity"), tags$th(colspan=1, "Points"), tags$th(rowspan=2, "Total")
                              ),
                              tags$tr(tags$th("Unit Count"), tags$th("Per Unit"))
                            ),
                            tags$tbody(
                              tags$tr(tags$td(class="label-col", "Short Interview"), tags$td(numericInput("m_short", NULL, 0, min=0)), tags$td("0.5"), tags$td(class="total-column", textOutput("t_mshort_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "Long Interview"), tags$td(numericInput("m_nat", NULL, 0, min=0)), tags$td("2"), tags$td(class="total-column", textOutput("t_mnat_out", inline=T))),
                              tags$tr(tags$td(class="label-col", "National/Press Release"), tags$td(numericInput("m_feat", NULL, 0, min=0)), tags$td("5"), tags$td(class="total-column", textOutput("t_mfeat_out", inline=T)))
                            )
                 )
             ),
             ...
             box(title = "VIII - Spotlight Score", width = 12, status = "primary", solidHeader = TRUE,
                 tags$table(class = "outreach-table",
                            tags$thead(
                              tags$tr(tags$th(class="cat-header", rowspan=2, "Item"), tags$th(colspan=2, "Quantity (Scale 0-18)"), tags$th(colspan=1, "Points"), tags$th(rowspan=2, "Total")),
                              tags$tr(tags$th("Faculty Score"), tags$th("ADO Score"), tags$th("Calculated Avg")) # Sub-header
                            ),
                            tags$tbody(
                              tags$tr(tags$td(class="label-col", "Significant Effort"), 
                                      tags$td(numericInput("s_fac", NULL, 0, min=0, max=18)), 
                                      tags$td(numericInput("s_ado", NULL, 0, min=0, max=18)), 
                                      tags$td(textOutput("spot_avg_display")), # <--- This box now updates live
                                      tags$td(class="total-column", textOutput("t_spot_out", inline=T)))
                            )
                 )
             ),
...
server <- function(input, output, session) {
  ...
  # II - Publications
  t_book   <- reactive({ calc_score(c(input$q_book, input$p_book), c(15, 16), w()) })
  t_chap   <- reactive({ calc_score(c(input$q_chap, input$p_chap), c(9, 10), w()) })
  t_jrnl   <- reactive({ calc_score(c(input$q_jrnl, input$p_jrnl), c(9, 10), w()) })
  t_proc   <- reactive({ calc_score(c(input$q_proc, input$p_proc), c(7, 8), w()) })
  ...
  # VI - Awards
  t_award  <- reactive({ calc_score(c(input$aw_b, input$aw_p), c(5, 7.5), 1.0) }) # Awards typically don't scale by FTE
  ...
  # VIII - Spotlight
  spot_avg <- reactive({
    f <- ifelse(is.na(input$s_fac), 0, input$s_fac)
    a <- ifelse(is.na(input$s_ado), 0, input$s_ado)
    (f + a) / 2
  })
  ...
  grand_total_val <- reactive({
    sum(t_prof(), t_nprof(), t_inv(), t_key(), t_book(), t_chap(), t_jrnl(), t_proc(), 
        t_out(), t_tech(), t_gray(), t_app(), t_pod(), t_smp(), t_smprod(), 
        t_event(), t_fnew(), t_fong(), t_tasite(), t_tarem(), t_award(), t_mshort(), 
        t_mnat(), t_mfeat(), t_spot())
  })
  output$grand_total <- renderText({ round(grand_total_val(), 2) })
  
  # Export Logic
  output$downloadData <- downloadHandler(
    filename = function() { paste0("Outreach_", Sys.Date(), ".csv") },
    content = function(file) {
      write.csv(data.frame(Category="Total", Score=grand_total_val()), file, row.names=F)
    }
  )
